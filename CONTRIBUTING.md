...
This section will walk you through setting up the [repository](https://github.com/canjs/jquery-demo) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork jquery-demo, you can start by going to its [fork page](https://github.com/canjs/jquery-demo/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/jquery-demo
```
